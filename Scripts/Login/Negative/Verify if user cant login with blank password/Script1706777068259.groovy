...
WebUI.setText(findTestObject('Page_Login - KG Media ID/input_KG Media ID_email'), 'testing@jac.com')

WebUI.setText(findTestObject('Page_Login - KG Media ID/input_Password_password'), '')

WebUI.delay(3)

WebUI.click(findTestObject('Page_Login - KG Media ID/input_Password_button -primary'))

WebUI.verifyElementPresent(findTestObject('Page_Login - KG Media ID/Password harus diisii'), 0)
